...
export function buildManifest(base: string): string {
  ...
  const manifest = {
    ...
    short_name,
    description:
      "A local-first calculator PWA: named sessions with a commentable tape, folders and namespaces, stored as markdown in a local folder or the cloud.",
    id: base,
    start_url: base,
    scope: base,
    display: "standalone",
...
// GENERATED — do not edit. Emitted by pwa-plugin.ts for the Calc PWA.
  ...
  return {
    ...
    transformIndexHtml(): HtmlTagDescriptor[] {
      return [
        ...
        {
          tag: "meta",
          attrs: { name: "apple-mobile-web-app-title", content: "Calc" },
          injectTo: "head",
        },
      ];
    },
