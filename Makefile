...
website:
	VITE_BASE=/calc/ npm run build

website-dev:
	npm run dev

# The dev server on the demo shelf: eight saved sessions in memory, nothing
# read from or written to this browser's storage (src/app/dev/demo.ts).
demo:
