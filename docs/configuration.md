...
| ------------ | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Device       | none                                  | The unconnected state: the working tape is kept on this device (IndexedDB) and a named session has nowhere to be written until a backend is connected. |
