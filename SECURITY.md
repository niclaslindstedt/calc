...
Instead, please report privately via [GitHub Security Advisories](https://github.com/niclaslindstedt/calc/security/advisories/new),
...
In scope: any vulnerability in the published release of calc — in
particular the OAuth token handling for the cloud storage backends and the
handling of calculation documents synced through them.
