...
// has no version of its own — it ships one build of the calculator, and the
...
module.exports = () => ({
  expo: {
    ...
    slug: "calc",
    version,
    // The app is a one-column calculator — a tape and the keys under it
    ...
    plugins: [
      ...
      // synced sessions show up under "Calc" in the Files app rather
    ...
    extra: {
      ...
      // calculator bundled inside it (assets/webroot.zip) from a loopback
      ...
      // a debug build at a deployed slot, set EXPO_PUBLIC_CALC_URL at
