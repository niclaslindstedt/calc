...
// guessing.
//
// Nothing about a session is read here, and nothing is stored. The only other
...
export const REPORT_TYPE = "calc-native/report";
...
export const AFTER_LOAD_SCRIPT = `(function () {
  if (window.__calcNativeReporter) return;
  window.__calcNativeReporter = true;
