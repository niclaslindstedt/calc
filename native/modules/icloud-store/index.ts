...
/**
 * The iCloud container the sessions sync through.
 *
 * Changing this after release strands every synced copy — the app starts
 * reading a container nothing has ever written, and the reader's sessions look
 ...
 */
export const ICLOUD_CONTAINER = "iCloud.se.agilator.calc";
