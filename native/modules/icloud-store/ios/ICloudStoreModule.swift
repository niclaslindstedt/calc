...
// sessions are visible in the Files app under "Calc" rather than
...
/// The container the sessions sync through. Kept in step with
...
private let CONTAINER_ID = "iCloud.se.agilator.calc"
...
public class ICloudStoreModule: Module {
  ...
  /// but the container holds the reader's whole set of sessionk, and a store that
  ...
  /// does not own. `calculations/.a.md.icloud` is `calculations/a.md`; any other
