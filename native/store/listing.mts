...
export const RULES: StoreRules = {
  ...
  brand: {
    ...
    marketingUrl: "https://calc.niclaslindstedt.se/",
    ...
    // behaviour does.
    privacyUrl: "https://apps.agilator.se/calc/privacy/",
    supportUrl: "https://apps.agilator.se/calc/support/",
  },

  // Calc ships on the App Store alone. There is no Mac App Store record and
  ...
  apple: {
    // A calculator. UTILITIES is where the store files calculators and where
    // somebody looking for one looks; PRODUCTIVITY second, for the saved and
    // annotated sessions.
    categories: ["UTILITIES", "PRODUCTIVITY"],

    advisory: {
      // A calculator. Every row is NONE and none of them is a judgement call:
      // the app evaluates expressions and keeps the tape and the notes the
